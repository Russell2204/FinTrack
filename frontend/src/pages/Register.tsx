    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-[#a6adc8] mt-1">Начните управлять финансами</p>
        </div>

        <div className="bg-surface rounded-2xl border border-white/5 p-8 shadow-2xl shadow-black/20">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-[#bac2de] mb-1.5">Имя (необязательно)</label>
              <input
                type="text"
                value={displayName}
        ...
        <p className="text-center text-sm text-[#a6adc8] mt-6">
          Уже есть аккаунт?{' '}
          <Link to="/login" className="text-primary-light hover:text-primary font-medium transition-colors duration-200">
            Войти
          </Link>
        </p>
      </div>
